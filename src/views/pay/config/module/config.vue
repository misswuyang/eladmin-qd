<template>
  <el-form ref="form" :model="form" :rules="rules" style="margin-top: 6px;" size="small" label-width="100px">
    <el-form-item label="我的密钥" >
      <el-input v-model="form.privateKey" style="width: 370px;" disabled/>
    </el-form-item>
    <el-form-item label="异步回调Url" >
      <el-input v-model="form.notifyUrl" style="width: 80%"/>
    </el-form-item>
    <el-form-item label="">
  ...
  methods: {
    init() {
      getPapConfig().then(res => {
        console.log('==created in config res:', res)
